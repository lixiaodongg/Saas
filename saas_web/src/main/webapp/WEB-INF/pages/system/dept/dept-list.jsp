                        ...
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建"
                                        onclick='location.href="/system/system/toAdd.do"'><i class="fa fa-file-o"></i> 新建
                                </button>
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <c:forEach items="${pageInfo.list}" var="dept" varStatus="st">
                            <tr>
                                ...
                                <td>${st.count }</td>
                                <td>${dept.deptId }</td>
                                <td>${dept.parent==null?"":dept.parent.deptName }</td>
                                <td><a href="/system/dept/toUpdate.do?deptId=${dept.deptId}">${dept.deptName }</a></td>
                                <th class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick='location.href="/system/system/toUpdate.do?deptId=${dept.deptId}"'>编辑
                                    </button>
                                </th>
                            </tr>
                        </c:forEach>
