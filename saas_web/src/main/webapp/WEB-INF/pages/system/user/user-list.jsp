...
<script>
    ...
    function roleList() {
        var id = getCheckId()
        if (id) {
            location.href = "/system/user/roleList.do?userId=" + id;
        } else {
            alert("请勾选待处理的记录，且每次只能勾选一个")
        }
    }
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <c:forEach items="${pageInfo.list}" var="item">
                            <tr>
                                ...
                                <td>
                                    <a href="${pageContext.request.contextPath}/system/user/toUpdate.do?userId=${item.userId}">${item.userName}</a>
                                </td>
                                <td>${item.deptName }</td>
                                <td>${item.email }</td>
                                ...
                                <th class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick='location.href="/system/user/toUpdate.do?userId=${item.userId}"'>编辑
                                    </button>
                                </th>
                            </tr>
                        </c:forEach>
