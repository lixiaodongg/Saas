package com.shadow.bean.cargo;

import com.shadow.bean.BaseEntity;
...
public class ContractProduct extends BaseEntity implements Serializable {
	...
	private List<ExportContractProduct> extCproducts ;	//货物和附件，一对多
	...
	public List<ExportContractProduct> getExtCproducts() {
		return extCproducts;
	}

	public void setExtCproducts(List<ExportContractProduct> extCproducts) {
